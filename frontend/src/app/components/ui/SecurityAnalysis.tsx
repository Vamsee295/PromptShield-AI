            ...
            <div className="bg-black rounded-xl border border-gray-800 p-6">
                <div className="flex items-center justify-center h-full">
                    <div className="text-center">
                        ...
                        <p className="text-white font-bold">Analyzing prompt...</p>
                    </div>
                </div>
            </div>
        );
            ...
            <div className="bg-black rounded-xl border border-gray-800 p-6">
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-2">
                        ...
                        <h3 className="text-lg font-black text-white">Security Analysis</h3>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-center h-64 text-center">
                    <div>
                        ...
                        <p className="text-gray-400 font-bold">
                            Enter a prompt and click <span className="font-black text-white">Scan Prompt</span> to analyze
                        </p>
                    </div>
                </div>
            </div>
