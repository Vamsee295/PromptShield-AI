    ...
    return (
        <div className="min-h-screen bg-gray-50 py-8 px-4">
            ...
            <header className="max-w-7xl mx-auto mb-8">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">PromptShield</h1>
                    </div>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-2 bg-white px-3 py-2 rounded-lg border border-gray-200">
                            <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                                <span className="text-blue-600 font-semibold text-sm">V</span>
                            </div>
                            <span className="text-sm font-medium text-gray-700">Vamsee</span>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-7xl mx-auto">
                {/* Page Title */}
                <div className="mb-6">
                    <h2 className="text-3xl font-bold text-gray-900 mb-2">Prompt Analyzer</h2>
